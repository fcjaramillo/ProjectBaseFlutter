...
class BaseTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color fixedBorderColor = borderColor ?? theme.border.scale.soft;
    Color fixedLabelColor = labelColor ?? theme.text.scale.soft;
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        suffixIcon: suffixIcon != null
            ...
            : null,
        suffix: suffix != null
            ? GestureDetector(onTap: onTapSuffixIcon, child: suffix)
            : null,
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
            color: focusedBorderColor ?? theme.border.scale.strong,
          ),
        ),
        errorBorder: OutlineInputBorder(
          borderRadius: borderRadius,
          borderSide: BorderSide(
            color: errorColor ?? theme.border.feedbacks.error,
          ),
        ),
