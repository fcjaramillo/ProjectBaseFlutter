...
class CardIconText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final CustomThemeColors customThemeColors = Theme.of(
      context,
    ...
    return GestureDetector(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          borderRadius: const BorderRadius.all(Radius.circular(Layout.spaceXS)),
        ),
        child: Visibility(
          ...
          replacement: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                BaseText(text, style: TypoCaption.c1),
                Spacing.spacingH8,
                Icon(
                  icon,
                  color: isSelected
