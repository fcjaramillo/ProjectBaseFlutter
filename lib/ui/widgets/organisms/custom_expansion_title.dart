...
class BaseCustomExpansionTileController {
  ...
  static BaseCustomExpansionTileController of(BuildContext context) {
    final _CustomExpansionTileState? result = context
    ...
    throw FlutterError.fromParts(<DiagnosticsNode>[
      ErrorSummary(
        '''CHCustomExpansionTileController.of() called with a context that does not contain a ExpansionTile.''',
      ),
      ErrorDescription(
        '''No ExpansionTile ancestor could be found starting from the context that was passed to CHCustomExpansionTileController.of(). '''
      ...
      ErrorHint(
        ...
        '''documentation for CHCustomExpansionTileController.of():\n'''
      ...
      ErrorHint(
        ...
        '''your new inner widgets, and then in these inner widgets you would use CHCustomExpansionTileController.of().\n'''
        ...
        'using the CHCustomExpansionTileController.of() function.',
      ),
...
class CHCustomExpansionTile extends StatefulWidget {
  const CHCustomExpansionTile({
    this.title,
    this.titleWidget,
    super.key,
  ...
  @override
  State<CHCustomExpansionTile> createState() => _CustomExpansionTileState();
}

class _CustomExpansionTileState extends State<CHCustomExpansionTile>
    ...
    children: <Widget>[
      GestureDetector(
        ...
        child: Container(
          ...
          decoration:
              widget.decorationTitle ??
              BoxDecoration(
                color: Theme.of(
                  context,
                ).colorScheme.onSurface.withValues(alpha: 0.05),
                borderRadius: !_isExpanded && _animationController.isDismissed
                    ? CHRadius.r_2
          ...
          child: Row(
            crossAxisAlignment:
                widget.crossAxisAlignmentTitleExpanded ??
                CrossAxisAlignment.center,
            mainAxisAlignment:
                widget.mainAxisAlignmentTitleExpanded ??
