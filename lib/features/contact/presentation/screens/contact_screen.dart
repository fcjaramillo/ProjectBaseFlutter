...
class _ContactScreenState extends State<ContactScreen> {
  ...
  Widget _buildContactSection(BuildContext context, bool isMobile) => Container(
      padding: EdgeInsets.symmetric(
        horizontal: isMobile ? 20 : 80,
        vertical: isMobile ? 60 : 100,
      ),
  ...
  Widget _buildContactInfo(BuildContext context) => Column(
      ...
      children: <Widget>[
        ...
        _ContactInfoItem(
          ...
          content: 'contacto@williamcampiño.com',
          onTap: () {},
        ),
  ...
  Widget _buildContactForm(BuildContext context, bool isMobile) => Container(
