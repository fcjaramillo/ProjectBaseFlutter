...
class _SupportScreenState extends ConsumerState<SupportScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    final Volunteer volunteer = Volunteer(
      ...
      skills: _selectedSkills.isEmpty
          ? null
          : List<String>.from(_selectedSkills),
    );
  ...
  Widget build(BuildContext context) {
    final SupportState supportState = ref.watch(supportViewModelProvider);
    ...
    ref.listen(
      ...
      (SupportState? previous, SupportState next) {
              ...
              content: Column(
                ...
                children: <Widget>[
                  Icon(
                    Iconsax.tick_circle,
                    size: 64,
                    color: Theme.of(ctx).appColors.success.strong,
                  ),
                  ...
                  BaseText(
                    'Hemos recibido tu registro. Pronto nos comunicaremos '
                    'contigo.',
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          Theme.of(ctx).appColors.primary.strong,
                      foregroundColor:
                          Theme.of(ctx).appColors.neutralNoChange.subtle,
                    ),
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        _buildVolunteerSection(context, isMobile, supportState),
          ...
          children: <Widget>[
            ...
            ConstrainedBox(
              ...
              child: BaseText.noChangeSubtle(
                'Tu apoyo es fundamental para construir el Popayan que '
                'sonamos. Hay muchas formas de sumarte a este movimiento '
                'ciudadano.',
      ...
      Container(
        ...
        child: Column(
          children: <Widget>[
            const SectionHeader(
              title: 'Se voluntario',
              subtitle: 'Registrate y forma parte de nuestro equipo '
                  'de voluntarios.',
            ),
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    const SizedBox(height: 24),
                    _buildDonationInfo(context, 'Banco', 'Bancolombia'),
                    _buildDonationInfo(context, 'Tipo de cuenta', 'Ahorros'),
                    _buildDonationInfo(
                        context, 'Numero', '000-000000-00'),
                    _buildDonationInfo(
                        context, 'Titular', 'Campana William Campino'),
                    _buildDonationInfo(context, 'NIT', '000.000.000-0'),
                    const SizedBox(height: 24),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        _buildPaymentMethod(
                            context, 'Nequi', Iconsax.mobile, '300 000 0000'),
                        const SizedBox(width: 24),
                        _buildPaymentMethod(
                            context, 'Daviplata', Iconsax.card, '300 000 0000'),
                      ],
                    ),
                  ],
                ),
  ...
  Widget _buildDonationInfo(BuildContext context, String label, String value) =>
      Padding(
      ...
      Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            BaseText(number, style: TypoSecondary.b3r),
          ],
        ),
      );
