...
typedef FailDef<T> = Fail<T, BackError>;
...
abstract class Result<T, E> {
  ...
  R when<R>({required R Function(E) fail, required R Function(T) success});
...
abstract class Error {
  ...
  const Error({required this.description, required this.err, this.data});
}
