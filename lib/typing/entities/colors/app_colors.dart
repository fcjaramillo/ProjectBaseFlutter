...
class AppColors {
  ...
  AppThemeColors appThemeColors() => AppThemeColors(
    ...
    success: ColorContrast(strong: success.v700, subtle: success.v50),
    informative: ColorContrast(
      strong: informative.v500,
      subtle: informative.v50,
    ),
    warning: ColorContrast(strong: warning.v700, subtle: warning.v50),
    error: ColorContrast(strong: error.v600, subtle: error.v50),
    neutral: ColorScale(
      strong: neutral.v950,
      base: neutral.v200,
      soft: neutral.v100,
    ...
    opacity: ColorBase(base: opacity.v600),
