...
-- =============================================
INSERT INTO events (title, description, event_date, event_time, location, address, is_featured, is_active) VALUES
('Gran Encuentro con Líderes Comunales', 'Reunión con más de 200 presidentes de juntas de acción comunal de los 9 corregimientos de Popayán. Espacio para escuchar las necesidades de cada barrio y presentar el plan de gobierno detallado.', '2026-03-08', '10:00:00', 'Centro de Convenciones de Popayán', 'Calle 4 # 6-59, Popayán, Cauca', TRUE, TRUE),
('Diálogo con Jóvenes Emprendedores', 'Foro-taller con emprendedores, estudiantes universitarios y jóvenes líderes para construir juntos las propuestas de desarrollo económico y empleo para Popayán.', '2026-03-15', '15:00:00', 'Universidad del Cauca - Auditorio Mayor', 'Carrera 2 # 1N-45, Popayán, Cauca', FALSE, TRUE),
('Recorrido por Barrios del Sur', 'Visita comunitaria a las comunas 8 y 9 del sur de Popayán para conocer de primera mano las necesidades de los barrios periféricos en infraestructura, seguridad y servicios públicos.', '2026-03-22', '08:00:00', 'Parque Principal - Barrio Moscopán', 'Calle 30 Sur # 12-15, Popayán, Cauca', FALSE, TRUE),
('Foro de Seguridad Ciudadana', 'Debate público sobre seguridad en Popayán con participación de expertos, líderes comunitarios y exfuncionarios de seguridad para analizar la situación actual y las propuestas de mejora.', '2026-01-20', '14:00:00', 'Teatro Municipal Guillermo Valencia', 'Calle 5 # 7-62, Popayán, Cauca', FALSE, TRUE),
('Lanzamiento Oficial de la Campaña', 'Evento de lanzamiento oficial de la campaña de William Campiño a la Alcaldía de Popayán, con presentación del plan de gobierno, música y participación ciudadana masiva.', '2025-11-15', '18:00:00', 'Parque Caldas - Centro Histórico', 'Carrera 7 # 4-22, Popayán, Cauca', TRUE, TRUE),
('Jornada Deportiva Comunitaria', 'Encuentro deportivo y cultural en el estadio municipal con participación de equipos barriales de fútbol, actividades recreativas para niños y presentaciones artísticas locales.', '2026-02-08', '09:00:00', 'Estadio Ciro López de Popayán', 'Carrera 9 # 37N-20, Popayán, Cauca', FALSE, TRUE);
...
-- =============================================
INSERT INTO communes (name, number, description, population, neighborhoods, color) VALUES
('El Centro', 1, 'La comuna histórica y cultural de Popayán, sede del gobierno municipal, universidades y el patrimonio arquitectónico colonial de la ciudad blanca. Corazón político, comercial y cultural de la ciudad.', 45000, ARRAY['El Centro', 'San Camilo', 'La Esmeralda', 'Yanaconas', 'San José'], '#DC2626'),
('El Empedrado', 2, 'Comuna residencial con amplio desarrollo urbano y comercial. Alberga importantes centros educativos, zonas comerciales y comunidades organizadas con fuerte participación ciudadana.', 52000, ARRAY['El Empedrado', 'Las Palmas', 'Santa Helena', 'Bella Vista', 'El Paraíso'], '#D97706'),
('El Libertador', 3, 'Zona norte de la ciudad con crecimiento acelerado, importantes vías de acceso y comunidades activas. Sede de varios colegios públicos y parques deportivos de la ciudad.', 48000, ARRAY['El Libertador', 'Nuevo Milenio', 'La Paz', 'El Triunfo', 'Villa del Rosario'], '#16A34A'),
('Comuneros', 4, 'Comuna con alta actividad comercial y empresarial. Concentra importantes centros de salud, mercados populares y zonas de pequeña industria que generan empleo local.', 61000, ARRAY['Comuneros', 'El Edén', 'Julio Rincón', 'El Rosario', 'La Paz Norte'], '#2563EB'),
('Alfonso López', 5, 'Zona universitaria por excelencia, con la presencia de la Universidad del Cauca y el SENA. Alta concentración de estudiantes, cafeterías y comercio universitario animado.', 39000, ARRAY['Alfonso López', 'Lorenzo de Aldana', 'La Ladera', 'Calicanto', 'El Jardín'], '#7C3AED'),
('Altos del Norte', 6, 'Comuna periurbana en la zona norte con barrios de expansión reciente, fuerte sentido comunitario y necesidades de infraestructura vial y servicios públicos prioritarios.', 35000, ARRAY['Altos del Norte', 'San Rafael', 'Villa Rosario', 'Los Pinos', 'La Esperanza Norte'], '#0891B2'),
('Los Libertadores', 7, 'Extensa zona occidental con mezcla de barrios consolidados y nuevos desarrollos de vivienda popular. Requiere inversión en movilidad, seguridad y equipamientos comunitarios.', 58000, ARRAY['Los Libertadores', 'La Floresta', 'El Carmen', 'Villa del Norte', 'Nuevo Horizonte'], '#BE185D'),
('El Lago', 8, 'Una de las comunas más populosas del sur, con barrios de alta densidad, problemáticas de seguridad y gran potencial de desarrollo. Comunidad organizada y propositiva en su relación con el municipio.', 72000, ARRAY['El Lago', 'Moscopán', 'La Pamba', 'Las Américas', 'Villa del Sur', 'El Recuerdo'], '#92400E'),
('Escuela Nacional de Policía', 9, 'Zona sur con características especiales por la presencia de la ESNAL. Mix de barrios residenciales, zonas verdes y corredores viales importantes de la ciudad.', 41000, ARRAY['ESNAL', 'Villa María', 'El Placer', 'La Arboleda', 'San Marcos'], '#065F46');
